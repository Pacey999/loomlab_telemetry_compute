...
static constexpr MeasureEntry FTCAN_MEASURES[] = {
    ...
    {0x0003, "engine.tps_pct", "%", 1.0f, false},
    {0x0004, "engine.map_bar", "bar", 0.001f, true},
    {0x0005, "engine.map_bar", "bar", 1.0f, false},
    {0x0006, "engine.air_temp_c", "°C", 0.1f, true},
    {0x0007, "engine.air_temp_c", "°C", 1.0f, false},
    {0x0008, "engine.coolant_temp_c", "°C", 0.1f, true},
    {0x0009, "engine.coolant_temp_c", "°C", 1.0f, false},
    {0x000A, "engine.oil_pressure_bar", "bar", 0.001f, true},
    {0x000B, "engine.oil_pressure_bar", "bar", 1.0f, false},
    {0x000C, "engine.fuel_pressure_bar", "bar", 0.001f, true},
    {0x000D, "engine.fuel_pressure_bar", "bar", 1.0f, false},
    {0x000E, "engine.water_pressure_bar", "bar", 0.001f, true},
    {0x000F, "engine.water_pressure_bar", "bar", 1.0f, false},
    {0x0010, "engine.launch_mode", "-", 1.0f, true},
    {0x0011, "engine.launch_mode", "-", 1.0f, false},
    {0x0012, "electrical.battery_v", "V", 0.01f, true},
    {0x0013, "electrical.battery_v", "V", 1.0f, false},
    {0x0014, "vehicle.traction_speed_kmh", "km/h", 1.0f, true},
    {0x0015, "vehicle.traction_speed_kmh", "km/h", 1.0f, false},
    {0x0016, "vehicle.drag_speed_kmh", "km/h", 1.0f, true},
    {0x0017, "vehicle.drag_speed_kmh", "km/h", 1.0f, false},
    {0x0018, "vehicle.wheel_speed_fl_kmh", "km/h", 1.0f, true},
    {0x0019, "vehicle.wheel_speed_fl_kmh", "km/h", 1.0f, false},
    {0x001A, "vehicle.wheel_speed_fr_kmh", "km/h", 1.0f, true},
    {0x001B, "vehicle.wheel_speed_fr_kmh", "km/h", 1.0f, false},
    {0x001C, "vehicle.wheel_speed_rl_kmh", "km/h", 1.0f, true},
    {0x001D, "vehicle.wheel_speed_rl_kmh", "km/h", 1.0f, false},
    {0x001E, "vehicle.wheel_speed_rr_kmh", "km/h", 1.0f, true},
    {0x001F, "vehicle.wheel_speed_rr_kmh", "km/h", 1.0f, false},
    {0x0020, "driveline.driveshaft_rpm", "rpm", 1.0f, true},
    {0x0021, "driveline.driveshaft_rpm", "rpm", 1.0f, false},
    {0x0022, "driveline.gear", "-", 1.0f, true},
    {0x0023, "driveline.gear", "-", 1.0f, false},
    {0x0024, "lambda.disabled_o2", "λ", 0.001f, true},
    {0x0025, "lambda.disabled_o2", "λ", 1.0f, false},
    {0x0026, "lambda.cyl1_o2", "λ", 0.001f, true},
    {0x0027, "lambda.cyl1_o2", "λ", 1.0f, false},
    {0x004A, "lambda.left_bank_o2", "λ", 0.001f, true},
    {0x004B, "lambda.left_bank_o2", "λ", 1.0f, false},
    {0x004C, "lambda.right_bank_o2", "λ", 0.001f, true},
    {0x004D, "lambda.right_bank_o2", "λ", 1.0f, false},
    {0x004E, "lambda.exhaust_o2", "λ", 0.001f, true},
    {0x004F, "lambda.exhaust_o2", "λ", 1.0f, false},
    {0x007A, "engine.egt_exhaust_c", "°C", 0.1f, true},
    {0x007B, "engine.egt_exhaust_c", "°C", 1.0f, false},
    {0x0084, "engine.rpm", "rpm", 1.0f, true},
    {0x0085, "engine.rpm", "rpm", 1.0f, false},
    {0x0086, "engine.inj_time_a_ms", "ms", 0.01f, true},
    {0x0087, "engine.inj_time_a_ms", "ms", 1.0f, false},
    {0x0088, "engine.inj_time_b_ms", "ms", 0.01f, true},
    {0x0089, "engine.inj_time_b_ms", "ms", 1.0f, false},
    {0x008A, "engine.inj_duty_a_pct", "%", 0.1f, true},
    {0x008B, "engine.inj_duty_a_pct", "%", 1.0f, false},
    {0x008C, "engine.inj_duty_b_pct", "%", 0.1f, true},
    {0x008D, "engine.inj_duty_b_pct", "%", 1.0f, false},
    {0x008E, "engine.ignition_advance_deg", "°", 0.1f, true},
    {0x008F, "engine.ignition_advance_deg", "°", 1.0f, false},
    {0x0090, "engine.two_step_signal", "-", 1.0f, true},
    {0x0091, "engine.two_step_signal", "-", 1.0f, false},
    {0x0096, "engine.cut_pct", "%", 1.0f, true},
    {0x0097, "engine.cut_pct", "%", 1.0f, false},
    {0x00A0, "driveline.gear_sensor_v", "V", 0.001f, true},
    {0x00A1, "driveline.gear_sensor_v", "V", 1.0f, false},
    {0x00A2, "lambda.average_o2", "λ", 0.001f, true},
    {0x00A3, "lambda.average_o2", "λ", 1.0f, false},
    {0x0116, "engine.trans_temp_c", "°C", 0.1f, true},
    {0x0117, "engine.trans_temp_c", "°C", 1.0f, false},
    {0x011A, "engine.oil_temp_c", "°C", 0.1f, true},
    {0x011B, "engine.oil_temp_c", "°C", 1.0f, false},
    {0x011C, "engine.pit_limit_switch", "-", 1.0f, true},
    {0x011D, "engine.pit_limit_switch", "-", 1.0f, false},
    {0x0282, "engine.fuel_consumption_l", "L", 1.0f, true},
    {0x0283, "engine.fuel_consumption_l", "L", 1.0f, false},
    {0x0290, "engine.fuel_flow_total_lpm", "L/min", 0.01f, true},
    {0x0291, "engine.fuel_flow_total_lpm", "L/min", 1.0f, false},
    {0x0296, "engine.brake_pressure_bar", "bar", 0.001f, true},
    {0x0297, "engine.brake_pressure_bar", "bar", 1.0f, false},
    {0x02E0, "vehicle.ride_height", "-", 1.0f, true},
    {0x02E1, "vehicle.ride_height", "-", 1.0f, false},
    {0x02E2, "vehicle.shock_fr", "-", 0.001f, true},
    {0x02E3, "vehicle.shock_fr", "-", 1.0f, false},
    {0x02E4, "vehicle.shock_fl", "-", 0.001f, true},
    {0x02E5, "vehicle.shock_fl", "-", 1.0f, false},
    {0x02E6, "vehicle.shock_rr", "-", 0.001f, true},
    {0x02E7, "vehicle.shock_rr", "-", 1.0f, false},
    {0x02E8, "vehicle.shock_rl", "-", 0.001f, true},
    {0x02E9, "vehicle.shock_rl", "-", 1.0f, false},
};

static constexpr uint16_t FTCAN_MEASURES_COUNT = 88;
